...
static void show_help(void) {
  printf( "usage:    nxweb <options>\n\n"
          ...
          " -P dir   set python2 root dir\n"
          " -W name  set python2 WSGI app fully qualified name\n"
          " -V path  set python2 virtualenv path\n"
          " -X dir   set python3 root dir\n"
          " -Y name  set python3 WSGI app fully qualified name\n"
          " -Z path  set python3 virtualenv path\n"
...
int nxweb_main_stub(int argc, char** argv, void (*server_main)()) {
  ...
  int c;
  while ((c=getopt(argc, argv, ":hvdsw:l:a:p:u:g:H:S:c:T:P:W:V:L:M:X:Y:Z:"))!=-1) {
    switch (c) {
      case 'h':
        show_help();
        return 0;
      ...
      case 'T':
        ...
        break;
      case 'P':
        nxweb_main_args.python2_root=optarg;
        break;
      case 'W':
        nxweb_main_args.python2_wsgi_app=optarg;
        break;
      case 'V':
        nxweb_main_args.python2_virtualenv_path=optarg;
        break;

      case 'X':
        nxweb_main_args.python3_root=optarg;
        break;
      case 'Y':
        nxweb_main_args.python3_wsgi_app=optarg;
        break;
      case 'Z':
        nxweb_main_args.python3_virtualenv_path=optarg;
        break;
