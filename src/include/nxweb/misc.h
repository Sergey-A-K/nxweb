...
typedef struct nxweb_main_args_t {
  ...
  const char* python2_root;
  const char* python2_wsgi_app;
  const char* python2_virtualenv_path;

  const char* python3_root;
  const char* python3_wsgi_app;
  const char* python3_virtualenv_path;
