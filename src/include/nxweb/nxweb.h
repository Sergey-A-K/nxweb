...
#ifdef WITH_PYTHON2
extern nxweb_handler nxweb_python2_handler;
#endif

#ifdef WITH_PYTHON3
extern nxweb_handler nxweb_python3_handler;
#endif
...
int nxweb_format_http_time(char* buf, struct tm* tm); //  "nxweb.h"
int nxweb_format_iso8601_time(char* buf, struct tm* tm);
