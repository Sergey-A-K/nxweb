...
#ifdef WITH_PYTHON2
  NXWEB_PYTHON2_SETUP(my_python2, "/py", .priority=950000,
        .dir="www/cache/upload_temp", .size=50000000, // file upload 50Mb size limit
        .filters={
            nxweb_file_cache_filter_setup("www/cache/python2"), &templates_filter, &ssi_filter
         });
#endif

#ifdef WITH_PYTHON3
  NXWEB_PYTHON3_SETUP(my_python3, "/py", .priority=950000,
        .dir="www/cache/upload_temp", .size=50000000, // file upload 50Mb size limit
        .filters={
            nxweb_file_cache_filter_setup("www/cache/python3"), &templates_filter, &ssi_filter
         });
#endif
